...
(function($) {
    ...
    $.bhTip = function(data) {
         ...
         * @property {String} [state=success] 提示类型，支持'success'/'warning'/'danger'三种类型
         * @property {String} [iconClass=icon-checkcircle] 图标样式，参照iconfont设置
         * @property {Object[]} [options] 自定义操作的数组，包含任意数量的操作对象：
         * @property {String} options.text 自定义按钮显示文字
         * @property {Function} options.callback 自定义按钮回调方法
         * @property {Function} [onClosed] 提示框关闭时的回调方法
         * @property {Number} [animateTimes=3000] 提示框持续显示时间
         */
        var bhTipDefaults = {
            content: '', // 必填，提示框的内容
